    ...
    return(
        <div className="w-full overflow-x-hidden">
            <div className="relative  overflow-x-hidden min-w-[100vw] h-[100vh]">
                ...
                <div>
                    <img id="photo1" src='assets\images\image 39-min.png' className=' absolute h-[17vh] lg:w-[10vw] md:w-[17vw] sm:w-[15vw] w-[25vw]  left-[33%] top-[7%] z-30 '></img>
                </div>
                <div>
                    <img id="photo2" src='assets/images/Screenshot 2025-10-11 at 1.26.27 AM 3-min.png' className=' absolute h-[12vh] lg:w-[9vw] w-[0vw] left-[44%] top-[11%] z-30'></img>
                </div>
                <div>
                    <img id="photo3" src='assets\images\ff9e85bb8336df6374aa9ad194d0466d-removebg-preview 2 (1)-min.png' className=' absolute h-[12vh] sm:w-[10vw] lg:w-[8vw] w-[0vw] left-[54%] top-[17%] z-30'></img>
                </div>
                <div>
                    <img id="photo4" src='assets/images/Screenshot 2025-10-11 at 1.13.56 AM 3 (1)-min.png' className=' absolute h-[10vh] lg:w-[8vw] w-[20vw] md:w-[15vw] left-[41%] top-[29%] z-30'></img>
                </div>
                <div>
                    <img id="photo5" src='assets\images\fa94095495270e3e8061f3df2ddc8ded-removebg-preview 1-min.png' className='absolute h-[20vh] lg:w-[7vw] md:w-[14vw] w-[18vw] left-[65%] top-[8%] z-30 '></img>
                </div>
